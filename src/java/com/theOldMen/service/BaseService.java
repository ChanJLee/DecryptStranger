...
public abstract class BaseService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        mVibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);//振动器
        mWakeLock = ((PowerManager) getSystemService(Context.POWER_SERVICE))
                .newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, APP_NAME);//电源状态锁唤醒后台
        addNotificationMGR();
    }
...
//        mNotificationIntent = new Intent(this, TheOldMenChatMainActivity.class);//MainActivity为聊天活动界面
        mNotificationIntent = TheOldMenChatMainActivity.getChatIntent(this, fromId);//MainActivity为聊天活动界面
    ...
    private void setNotification(String fromJid, String fromUserId,
        ...
        if (isTicker) {
            ...
            ticker = author;
        mNotification = new Notification(R.drawable.logo_notify, ticker,
