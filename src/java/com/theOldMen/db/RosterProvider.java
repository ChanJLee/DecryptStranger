...
public class RosterProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.theOldMen.provider.Roster";
	...
	private static RosterDatabaseHelper mOpenHelper;
    ...
    private static class RosterDatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE " + TABLE_ROSTER + " ("
					...
					+ RosterConstants.USER_ID
					+ " TEXT UNIQUE ON CONFLICT REPLACE, "
					+ RosterConstants.USER_ALIAS + " TEXT, "
        ...
        public void clearDatabase(){
            if(myDb != null){
                myDb.execSQL("DROP TABLE IF EXISTS " + TABLE_GROUPS);
                myDb.execSQL("DROP TABLE IF EXISTS " + TABLE_ROSTER);
                onCreate(myDb);
            }
            else
                L.i("DATABASE","NOT EXIST");
        }
	...
	public static final class RosterConstants implements BaseColumns {
        ...
        public static final String OFFLINE_NUMBER = "0";
        public static final String ONLINE_MEMBERS = "members";


		public static final String DEFAULT_SORT_ORDER = STATUS_MODE + " DESC, "
				+ USER_ALIAS + " COLLATE NOCASE";

		public static ArrayList<String> getRequiredColumns() {
			ArrayList<String> tmpList = new ArrayList<String>();
			tmpList.add(USER_ID);
			tmpList.add(USER_ALIAS);
