...
public class RadioButton extends CompoundButton {
    ...
    public RadioButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.MyRadioButton);
        mColor = attributes.getColor(R.styleable.MyRadioButton_radio_color,
                getResources().getColor(R.color.radio_color));
        mCheckedColor = attributes.getColor(R.styleable.MyRadioButton_radio_checked_color,
