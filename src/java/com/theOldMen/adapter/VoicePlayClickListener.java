...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public VoicePlayClickListener(EMMessage message,
								  ImageView v,
								  ImageView iv_read_status,
								  BaseAdapter adapter,
								  Activity activity,
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((TheOldMenChatMainActivity) activity).m_playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((TheOldMenChatMainActivity) activity).m_playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		if (isPlaying) {
			if (((TheOldMenChatMainActivity) activity).m_playMsgId != null &&
					((TheOldMenChatMainActivity) activity).m_playMsgId.equals(message.getMsgId())) {
