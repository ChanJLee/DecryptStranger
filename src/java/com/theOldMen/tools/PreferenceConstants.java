...
public class PreferenceConstants {
    ...
    public final static String DOMAIN = "jz-pc";
	...
	public final static String CUSTOM_SERVER = "CUSTOM_SERVER_IP";
    ...
    public final static String AUTO_SAVE_PASSWORD = "auto_save_password";
